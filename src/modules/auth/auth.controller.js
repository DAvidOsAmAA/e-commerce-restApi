...
export const register = async (req, res, next) => {
  ...
  if (!messageSend) return next(new Error("Something went wrong sending the email"))
...
export const resetPassword = async (req, res, next) => {
  ...
  return res.json({ success: true, message: "try to login again with the new password" })
}